		...
		if ( !empty( $hoot_options_premium ) && is_array( $hoot_options_premium ) ):
			$pcontent .= '<div id="hoot-psection" class="hoot-psection">';
				...
				$pcontent .= '<p class="hoot-upsell-cta centered pcontent-actions pcontent-top">';
					if ( !empty( $plink ) ) $pcontent .= '<a class="button button-primary" href="' . esc_url( $plink ) . '" target="_blank"><i class="fa fa-star"></i> ' . __( 'Buy Now', 'dispatch' ) . '</a>';
					if ( !empty( $pdemo ) ) $pcontent .= '<a class="button button-secondary" href="' . esc_url( $pdemo ) . '" target="_blank"><i class="fa fa-eye"></i> ' . __( 'Theme Demo', 'dispatch' ) . '</a>';
				$pcontent .= '</p>';
